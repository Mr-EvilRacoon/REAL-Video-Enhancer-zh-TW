...
ZH_TW = {
    ...
    "ROCm": "ROCm",
    "XPU": "XPU",
    "NCNN Vulkan (All GPUs, Fast and Lightweight)": "NCNN Vulkan（所有 GPU，快速輕量）",
    "PyTorch (NVIDIA/CUDA, High VRAM)": "PyTorch（NVIDIA/CUDA，高視訊記憶體）",
    "TensorRT (Nvidia RTX, Fastest)": "TensorRT（Nvidia RTX，最快）",
    "DirectML - NOT IMPLEMENTED YET (All GPUs, Placeholder)": "DirectML - 尚未實作（所有 GPU，佔位符）",
    "mean": "平均值",
